                ...
                <div className="relative z-10 mx-auto max-w-7xl custom-padding">
                    ...
                    >
                        ...
                        <motion.span
                            ...
                            className="mb-3 text-sm font-medium tracking-[0.2em] uppercase text-slate-500"
                        >
                        ...
                        >
                            <div className="relative">
                                ...
                                >
                                    <span className="text-[10px] md:text-xs font-medium text-slate-400 uppercase tracking-wider">Sells Growth</span>
                                    <div className="flex items-baseline gap-2 mt-1">
                                        <h4 className="text-xl md:text-2xl font-medium text-slate-900">+28%</h4>
                                    </div>
                                ...
                                >
                                    <h4 className="text-[10px] md:text-xs font-medium text-slate-400 uppercase tracking-wider mb-3">User Data</h4>
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="text-xs font-medium text-slate-900">Jesse Thomas</p>
                                                    <p className="text-[10px] text-slate-400">627 Points - 98% Correct</p>
                                                </div>
                                            </div>
                                            <span className="text-xs font-medium text-green-500 flex items-center gap-0.5">1 ▲</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-full bg-slate-100 overflow-hidden border border-white">
                                                ...
                                                <div>
                                                    <p className="text-xs font-medium text-slate-900">Thisal Mathiyazhagan</p>
                                                    <p className="text-[10px] text-slate-400">837 Points - 89% Correct</p>
                                                </div>
                                            </div>
                                            <span className="text-xs font-medium text-red-500 flex items-center gap-0.5">2 ▼</span>
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
